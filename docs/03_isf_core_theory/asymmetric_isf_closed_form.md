...
<NumericQuiz
  prompt="同一顆 N = 5、η = 1 的 ring，device 1/f corner f₁/f = 1 MHz。波形不對稱比從 A = 1.5 略微惡化到 A = 2，1/f³ corner 變成原來的幾倍？（提示：這個比值與 [P1]/[P2] 的 2 倍慣例無關）"
  answer={2.33}
  tol={0.02}
  unit="倍"
  hint="Eq.(57) 裡只有 (1−A)²/(1−A+A²) 隨 A 變：A=1.5 給 0.25/1.75 = 1/7，A=2 請自己代公式算一次。"
  solutionNote="A=2 時 (1−A)²/(1−A+A²) = 1/3；比值 = (1/3)/(1/7) = 7/3 ≈ 2.33（比 A 惡化到 3 的 4.0 倍溫和很多——A 越接近 1，corner 對 A 越不敏感）。"
/>
