...
> Prerequisites: [white_noise_to_phase_noise](/03_isf_core_theory/white_noise_to_phase_noise) | Next: [rms_isf](/03_isf_core_theory/rms_isf)
>
...
> **Site convention**: here $\alpha$ is the DC offset of the toy ISF $\Gamma=\cos\theta+\alpha$ ($c_0=2\alpha$), unrelated to [P1]'s NMF $\alpha(\omega_0t)$ (the cyclostationary noise modulation function; see [effective_isf](/03_isf_core_theory/effective_isf)).
...
> **Translator's note**: this figure is generated by a script with Chinese text baked into the image. Title reads: "ISF Fourier reconstruction (越多 harmonic 越接近)" = ISF Fourier reconstruction (more harmonics → closer to the original).
