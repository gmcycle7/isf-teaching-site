...
Symmetric vs asymmetric comparison (`fig_symmetric_vs_asymmetric`; **site convention**: `alpha` below is the
DC offset of the toy ISF, $c_0=2\alpha$, unrelated to [P1]'s NMF $\alpha(\omega_0t)$):
