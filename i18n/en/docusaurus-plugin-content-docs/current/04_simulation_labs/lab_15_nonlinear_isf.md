...
> **Translator's note**: this figure is generated by a script with Chinese text baked into the image. Titles read: "(a) van der Pol 波形：μ 越大越偏離正弦 (relaxation)" = (a) van der Pol waveform: larger μ deviates more from a sinusoid (relaxation); "(b) ISF 隨大訊號波形改變：大 μ 明顯非正弦" = (b) the ISF changes with the large-signal waveform: at large μ it is clearly non-sinusoidal.
