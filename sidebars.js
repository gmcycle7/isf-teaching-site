  ...
  mainSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        '03_isf_core_theory/asymmetric_isf_closed_form',
        '03_isf_core_theory/isf_from_waveform',
        '03_isf_core_theory/white_noise_to_phase_noise',
        '03_isf_core_theory/lorentzian_linewidth',
        '03_isf_core_theory/diffusion_dictionary',
        '03_isf_core_theory/beyond_lorentzian',
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            '04_simulation_labs/lab_40_subharmonic_injection',
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: 'category',
          label: '注入與頻率轉換 Injection & frequency conversion',
          collapsed: true,
          items: [
            '06_design_insights/quadrature_and_coupled_oscillators',
            '06_design_insights/injection_locking_noise',
        ...
        {
          type: 'category',
          label: '系統與量測 System & measurement',
          collapsed: true,
          items: [
            ...
            '06_design_insights/common_mistakes',
          ],
        },
